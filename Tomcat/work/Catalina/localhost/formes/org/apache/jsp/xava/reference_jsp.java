 ...
 * Generated at: 2021-01-15 17:23:38 UTC
...
public final class reference_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/xava/htmlTagsEditor.jsp", Long.valueOf(1610442906000L));
    _jspx_dependants.put("/xava/imports.jsp", Long.valueOf(1610442906000L));
    ...
    _jspx_dependants.put("/xava/referenceActionsExt.jsp", Long.valueOf(1607507368000L));
    ...
    _jspx_dependants.put("/xava/referenceActions.jsp", Long.valueOf(1610442908000L));
  }
...
String label = ref.getLabel(request);
 ...
 if (labelFormat == MetaPropertyView.NORMAL_LABEL) { 
      ...
      try {
        ...
        // /xava/reference.jsp(62,10) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
if (labelFormat == MetaPropertyView.SMALL_LABEL) { 
      ...
      try {
        ...
        // /xava/reference.jsp(71,10) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
String script = throwChanged?
 ...
 String required = view.isEditable() && ref.isRequired() ? "class='" + style.getRequiredEditor() + "'":""; 
      ...
      try {
        ...
        // /xava/reference.jsp(135,10) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
